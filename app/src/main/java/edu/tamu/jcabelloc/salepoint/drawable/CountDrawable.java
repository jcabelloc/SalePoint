package edu.tamu.jcabelloc.salepoint.drawable;
...
public class CountDrawable extends Drawable {
    ...
    public CountDrawable(Context context) {
        ...
        mBadgePaint.setColor(ContextCompat.getColor(context.getApplicationContext(), R.color.bagde_cart_background_color));
